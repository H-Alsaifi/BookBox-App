...
class SignUp : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //setting an onClickListener for the signun button
        bind.signupButton.setOnClickListener {
            //varibales to get input from the user and removing the spaces
                ...
                if (pass == checkPass) {
                    ...
                    auth.createUserWithEmailAndPassword(email, pass)
                        .addOnCompleteListener { task ->
                            //if sign up is successful proceed to input the data to databaase
